...
interface ITransaction {
    ...
    senderReference: string | null, senderAddress: string | null, senderModeReference: string | null,
    senderOriginator: string | null, cardNumber: string | null, cardLocation: string | null, cardType: string | null,
    cardBrand: string | null, investmentInstrumentName: string | null, bookingTypeTranslation: string | null,
    e2eReference: string | null, virtualCardNumber: string, virtualCardDeviceName: string,
    virtualCardMobilePaymentApplicationName: string, sepaMandateId: string, sepaCreditorId: string,
    sepaPurposeType: string | null, instructionName: string | null, loanReference: string | null,
    paymentMethod: string | null, pinEntry: string | null
}
...
export class Transaction {
    ...
    constructor(
        ...
        if (booking instanceof Date)
            this._booking = booking;
        else
            this._booking = new Date(booking);

        if (valuation instanceof Date)
            this._valuation = valuation;
        else
            this._valuation = new Date(valuation);
        ...
        this._virtualCardMobilePaymentApplicationName = virtualCardMobilePaymentApplicationName;
...
export function objToTransaction(obj: ITransaction): Transaction {
    ...
    return new Transaction(obj.booking, obj.valuation, obj.partnerName, obj.partnerAccount==null?null:objToPartnerAccount(obj.partnerAccount),
        ...
        obj.senderReference, obj.senderAddress, obj.senderModeReference,
        obj.senderOriginator, obj.cardNumber, obj.cardLocation, obj.cardType,
        obj.cardBrand, obj.investmentInstrumentName, obj.bookingTypeTranslation,
        obj.e2eReference, obj.virtualCardNumber, obj.virtualCardDeviceName,
        obj.virtualCardMobilePaymentApplicationName, obj.sepaMandateId, obj.sepaCreditorId,
        obj.sepaPurposeType, obj.instructionName, obj.loanReference,
